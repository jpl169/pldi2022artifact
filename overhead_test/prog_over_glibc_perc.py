...
labels = ["ln", "log2", "log10", "exp", "exp2", "exp10", "cosh", "sinh", "avg."]

elemental_files = ["log.txt", "log2.txt", "log10.txt", "exp.txt", "exp2.txt", "exp10.txt", "cosh.txt", "sinh.txt"]
...
plt.savefig('prog_over_glibc_perc.pdf', bbox_inches='tight', pad_inches = -0.001)
